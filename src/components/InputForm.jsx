        ...
        <View style={tw`flex-row justify-evenly`}>
          {['male', 'female'].map((gender) => (
            <TouchableOpacity
              key={gender}
              style={[
                tw`items-center justify-center p-4 w-32 rounded-xl`,
                userData.gender === gender
                  ? gender === 'female'
                    ? tw`bg-pink-100 border-2 border-pink-400 shadow-lg`
                    : tw`bg-blue-100 border-2 border-blue-500 shadow-lg`
                  : tw`bg-gray-100`
              ]}
